...
class Keyboard(Behave):
	...
	@staticmethod 
	def letter_filter(self, unfiltered_arr):
		"""Static method. 
	...
	@staticmethod
	def keyname_filter(self, unfiltered_arr, keyname_str):
	...
	def get_keyboard_params(self):
		...
		val_arr['dwell_time_average'] = letter_instance.average(self.dwell_time())
		val_arr['flight_time_average'] = letter_instance.average(self.flight_time())
		val_arr['rtor_time_average'] = letter_instance.average(self.release_to_release())
		val_arr['ptop_time_average'] = letter_instance.average(self.press_to_press())
