...
class Behave_Visualization:
	...
	def dwell_flight_params(self):
		...
		ax.set_xticklabels(["","1 second","2 second","3 second","4 second","5 second","6 second", "7 second"], fontsize=8)
		plt.title("Dwell & Flight time chart")
		plt.ylabel("Button state", fontsize=12)
	...
	def durations(self):
		...
		ax.plot(x_values, durations, "o-", label="Paramter value", color="b")

		ax.plot(x_values, averages, linewidth=2, label="Average", color="g")
	...
	def release_to_release(self, id):
		...
		ax.plot(x_values, release_to_release, "o-", label="Paramter value", color="b")
		...
		plt.title("Release-to-Release time chart")

		plt.ylabel("Release-to-Release time")
	...
	def press_to_press(self, id):
		...
		ax.plot(x_values, press_to_press, "o-", label="Parameter value", color="b")
		...
		plt.title("Press-to-Press time chart")

		plt.ylabel("Press-to-Press time")
	...
	def flight(self, id):
		...
		ax.plot(x_values, flight_time, "o-", label="Paramter value", color="b")
	...
	def dwell(self, id):
		...
		ax.plot(x_values, dwell_time, "o-", label="Parameter value", color="b")

		ax.plot(x_values, averages, linewidth=2, label="Average", color="g")

		ax.add_patch(rect)

		legend = ax.legend(loc="center", shadow=False)

		# fig.ylim[x_values[0], x_values[len(x_values)-1]]

		plt.title("Dwell time chart")
	...
	def mouse_speed(self, id):
		...
		ax.plot(x_values, move_speed, "o-", label="Paramter value", color="b")
		...
		plt.title("Mouse speed chart")

		plt.ylabel("mouse speed time")

		plt.xlabel("Tracking time")
...
if __name__ == "__main__":
	Behave_Visualization().release_to_release(33)
	Behave_Visualization().press_to_press(33)
	Behave_Visualization().flight(33)
	Behave_Visualization().dwell(33)
	Behave_Visualization().mouse_speed(33)
